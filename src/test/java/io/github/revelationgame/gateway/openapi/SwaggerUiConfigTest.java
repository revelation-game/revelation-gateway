...
class SwaggerUiConfigTest {
    ...
    void swaggerConfig() {
        ...
        SwaggerUrl expectedUrl1 = new SwaggerUrl("/url1", "hostname/url1/custom-open-api/v3/api-docs?serverUrl=hostname/url1");
        SwaggerUrl expectedUrl2 = new SwaggerUrl("/url2", "hostname/url2/custom-open-api/v3/api-docs?serverUrl=hostname/url2");
